...
(setq dehong-programming-packages
      '(
        css-mode
        paredit
        lispy
...
(defun dehong-programming/post-init-robe ()
  (progn
    (add-hook 'inf-ruby-mode-hook 'spacemacs/toggle-auto-completion-on)
    (defun dehong/ruby-send-current-line (&optional print)
    ...
    (defun dehong/ruby-send-current-line-and-go ()
      (interactive)
      (dehong/ruby-send-current-line)
      (ruby-switch-to-inf t))

    (defun dehong/start-inf-ruby-and-robe ()
      (interactive)
    ...
    (dolist (mode '(ruby-mode enh-ruby-mode))
      (spacemacs/set-leader-keys-for-major-mode mode
        "sb" 'ruby-send-block
        "sB" 'ruby-send-buffer
        "sl" 'dehong/ruby-send-current-line
        "sL" 'dehong/ruby-send-current-line-and-go
        "sI" 'dehong/start-inf-ruby-and-robe))))

(defun dehong-programming/init-editorconfig ()
  (use-package editorconfig
    :init
    (progn
      (defun conditional-enable-editorconfig ()
        (if (and (dehong/git-project-root)
                 (locate-dominating-file default-directory ".editorconfig"))
            (editorconfig-apply)))
      (add-hook 'prog-mode-hook 'conditional-enable-editorconfig))))

(defun dehong-programming/post-init-cider ()
  (setq cider-cljs-lein-repl
        "(do (require 'figwheel-sidecar.repl-api)
           (figwheel-sidecar.repl-api/start-figwheel!)
           (figwheel-sidecar.repl-api/cljs-repl))")

  (defun dehong/cider-figwheel-repl ()
    (interactive)
    (save-some-buffers)
  ...
  (global-set-key (kbd "C-c C-f") #'dehong/cider-figwheel-repl))

(defun dehong-programming/post-init-graphviz-dot-mode ()
  (with-eval-after-load 'graphviz-dot-mode
      (require 'company-keywords)
      (push '(graphviz-dot-mode  "digraph" "node" "shape" "subgraph" "label" "edge" "bgcolor" "style" "record") company-keywords-alist)))

(defun dehong-programming/post-init-dumb-jump ()
...
(defun dehong-programming/post-init-clojure-mode ()
  )

(defun dehong-programming/post-init-emacs-lisp ()
    (remove-hook 'emacs-lisp-mode-hook 'auto-compile-mode))

(defun dehong-programming/post-init-python ()
  (add-hook 'python-mode-hook #'(lambda () (modify-syntax-entry ?_ "w")))
  ;; if you use pyton3, then you could comment the following line
  (setq python-shell-interpreter "python"))

(defun dehong-programming/init-ctags-update ()
...
;; (defun dehong-programming/init-js-comint ()
...
(defun dehong-programming/post-init-web-mode ()
...
(defun dehong-programming/post-init-yasnippet ()
  (progn
    ...
    (spacemacs/add-to-hooks 'dehong/load-yasnippet '(prog-mode-hook
                                                            markdown-mode-hook
                                                            org-mode-hook))
    ))

(defun dehong-programming/post-init-racket-mode ()
  (progn
...
(defun dehong-programming/post-init-json-mode ()
...
(defun dehong-programming/init-nodejs-repl ()
  (use-package nodejs-repl
    :init
    :defer t))

(defun dehong-programming/init-flycheck-package ()
  (use-package flycheck-package))

(defun dehong-programming/init-lispy ()
  (use-package lispy
    :defer t
    :init
    (progn
...
(defun dehong-programming/init-cmake-font-lock ()
  (use-package cmake-font-lock
    :defer t))

(defun dehong-programming/init-google-c-style ()
  (use-package google-c-style
    :init (add-hook 'c-mode-common-hook 'google-set-c-style)))

(defun dehong-programming/post-init-cmake-mode ()
  (progn
...
(defun dehong-programming/post-init-flycheck ()
...
(defun dehong-programming/post-init-eldoc ()
  (setq eldoc-idle-delay 0.4))


(defun dehong-programming/post-init-js2-refactor ()
  (progn
    (spacemacs/set-leader-keys-for-major-mode 'js2-mode
      "r>" 'js2r-forward-slurp
      "r<" 'js2r-forward-barf)))

(defun dehong-programming/post-init-js2-mode ()
  (progn
    ...
    (dehong|toggle-company-backends company-tern)

    (spacemacs/set-leader-keys-for-major-mode 'js2-mode
      "tb" 'dehong/company-toggle-company-tern)
...
(defun dehong-programming/post-init-css-mode ()
  (progn
...
(defun dehong-programming/post-init-tagedit ()
  (add-hook 'web-mode-hook (lambda () (tagedit-mode 1))))

;; For each extension, define a function dehong/init-<extension-name>
;;
(defun dehong-programming/init-doxymacs ()
  "Initialize doxymacs"
...
(defun dehong-programming/init-nodejs-repl-eval ()
...
(defun dehong-programming/post-init-lua-mode ()
  (progn
...
(defun dehong-programming/post-init-cc-mode ()
  (progn
...
(defun dehong-programming/init-flycheck-clojure ()
  (use-package flycheck-clojure
    :defer t
    :init
    (eval-after-load 'flycheck '(flycheck-clojure-setup))))

(defun dehong-programming/post-init-ycmd ()
  (progn
    ...
    (dehong|toggle-company-backends company-ycmd)
    (eval-after-load 'ycmd
      '(spacemacs|hide-lighter ycmd-mode))

    (spacemacs/set-leader-keys-for-major-mode 'c-mode
      "tb" 'dehong/company-toggle-company-ycmd)
    (spacemacs/set-leader-keys-for-major-mode 'c++-mode
      "tb" 'dehong/company-toggle-company-ycmd)))

;; when many project has the need to use tags, I will give etags-table and etags-update a try
(defun dehong-programming/init-etags-select ()
...
(defun dehong-programming/post-init-company ()
  (progn
